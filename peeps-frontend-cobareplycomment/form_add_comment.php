        ...
        <div class="row gutter--15">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <textarea  id="CommentData" placeholder="Comment *" class="form-control" required></textarea>
                </div>
                <div class="col-sm-12" style="margin:2px;" id="plsTypecmt"></div>
            </div>

            <div class="col-sm-12 pt--10">
                <button class="btn btn-sm btn-primary fs--14" type="submit" id="Csubmit">Post Comment</button>
            </div>
        </div>
   <!--  </form> -->
</div>