<div class='main--content col-md-8 pb--60' data-trigger='stickyScroll'>
    <div class='main--content-inner drop--shadow'>
                            ...
                            <?php
                                    $id = $_GET['id'];   
                                    $query = mysqli_query($konek, "SELECT *,UNIX_TIMESTAMP() - tanggal AS TimeSpent from post LEFT JOIN user on user.id_user = post.id_user where id_post='$id' order by id_post DESC");
                            ...
                            <div class="comment--list pt--40">
                                ...
                                <ul class="comment--items nav">
                                    <li>
                                        ...
                                        <!-- LIHAT KOMEN -->
                                        <?php 
                                            $comment_query = mysqli_query ($konek, "SELECT * ,UNIX_TIMESTAMP() - date_posted AS TimeSpent FROM comment LEFT JOIN user on user.id_user = comment.id_user where id_post = '$id' order by date_posted DESC") or die (mysqli_error());
                                            while ($comment_row=mysqli_fetch_array($comment_query)){
